...
if needed, save the changes and publish it. Services like
[Medium](https://medium.com) or [DEV Community](https://dev.to) already solve
this problem, so why reinventing the wheel?
...
I don't like their workflow for publishing articles. However, with Github
Pages I would have some advantages:
...
does not include Ruby, Jekyll is written in Ruby. So, the real question is...
Why Jekyll?
...
Jekyll runs in Ruby, so we need Ruby. There are several methods for installing
Ruby, but I really like [asdf](https://github.com/asdf-vm/asdf) to install new
languages in my machine (I use it for Elixir and Erlang).
